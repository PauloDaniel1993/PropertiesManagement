...
public static class TimelineCatalog
{
  private static readonly Dictionary<string, (string Pt, string En)> EventLabels =
    new(StringComparer.OrdinalIgnoreCase)
    {
      ...
      ["vehicle.authorized"] = ("Veiculo autorizado", "Vehicle authorized"),
      ["vehicle.denied"] = ("Veiculo negado", "Vehicle denied"),
      ["vehicle.parking-updated"] = ("Vaga do veiculo atualizada", "Vehicle parking updated"),
      ["vehicle.archived"] = ("Veiculo arquivado", "Vehicle archived"),
      ["vehicle.restored"] = ("Veiculo restaurado", "Vehicle restored"),
      ["occurrence.created"] = ("Ocorrencia criada", "Occurrence created"),
      ["occurrence.updated"] = ("Ocorrencia atualizada", "Occurrence updated"),
      ["occurrence.assigned"] = ("Ocorrencia atribuida", "Occurrence assigned"),
      ["occurrence.unassigned"] = ("Ocorrencia sem responsavel", "Occurrence unassigned"),
      ["occurrence.priority-changed"] = ("Prioridade da ocorrencia alterada", "Occurrence priority changed"),
      ["occurrence.status-changed"] = ("Status da ocorrencia alterado", "Occurrence status changed"),
      ["occurrence.resolved"] = ("Ocorrencia resolvida", "Occurrence resolved"),
      ["occurrence.cancelled"] = ("Ocorrencia cancelada", "Occurrence cancelled"),
      ["occurrence.comment-added"] = ("Comentario em ocorrencia", "Occurrence comment added"),
      ["occurrence.document-linked"] = ("Documento vinculado a ocorrencia", "Occurrence document linked"),
      ["occurrence.archived"] = ("Ocorrencia arquivada", "Occurrence archived"),
      ["occurrence.restored"] = ("Ocorrencia restaurada", "Occurrence restored"),
