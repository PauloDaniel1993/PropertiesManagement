...
#pragma warning restore CA1308
  ...
  private static string EventTypeLabel(string eventName, string? locale)
  {
    ...
    return normalized switch
    {
      ...
      "vehicle.created" => portuguese ? "Veiculo cadastrado" : "Vehicle registered",
      "vehicle.updated" => portuguese ? "Veiculo atualizado" : "Vehicle updated",
      "vehicle.authorized" => portuguese ? "Veiculo autorizado" : "Vehicle authorized",
      "vehicle.denied" => portuguese ? "Veiculo negado" : "Vehicle denied",
      "vehicle.parking-updated" => portuguese ? "Vaga do veiculo atualizada" : "Vehicle parking updated",
      "vehicle.archived" => portuguese ? "Veiculo arquivado" : "Vehicle archived",
      "vehicle.restored" => portuguese ? "Veiculo restaurado" : "Vehicle restored",
      "occurrence.created" => portuguese ? "Ocorrencia criada" : "Occurrence created",
      "occurrence.updated" => portuguese ? "Ocorrencia atualizada" : "Occurrence updated",
      "occurrence.assigned" => portuguese ? "Ocorrencia atribuida" : "Occurrence assigned",
      "occurrence.unassigned" => portuguese ? "Ocorrencia sem responsavel" : "Occurrence unassigned",
      "occurrence.priority-changed" => portuguese ? "Prioridade da ocorrencia alterada" : "Occurrence priority changed",
      "occurrence.status-changed" => portuguese ? "Status da ocorrencia alterado" : "Occurrence status changed",
      "occurrence.resolved" => portuguese ? "Ocorrencia resolvida" : "Occurrence resolved",
      "occurrence.cancelled" => portuguese ? "Ocorrencia cancelada" : "Occurrence cancelled",
      "occurrence.comment-added" => portuguese ? "Comentario em ocorrencia" : "Occurrence comment added",
      "occurrence.document-linked" => portuguese ? "Documento vinculado a ocorrencia" : "Occurrence document linked",
      "occurrence.archived" => portuguese ? "Ocorrencia arquivada" : "Occurrence archived",
      "occurrence.restored" => portuguese ? "Ocorrencia restaurada" : "Occurrence restored",
